#!/usr/bin/env python3
"""
YOLOv11 pose training for the 4-keypoint gauge dataset (yolo_dataset_1c4p_9k).
...
DATASET_PATH = BASE_DIR / "yolo_dataset_1c4p_9k"
...
RUN_NAME = 'yolov11_pointer_pose_1c4p_9k'
KEYPOINT_COLORS = [
    (0, 255, 0),
    (255, 0, 0),
    (0, 255, 255),
...
def main():
    """Entry point for launching training on the 1c4p_9k dataset."""
    print("=" * 60)
