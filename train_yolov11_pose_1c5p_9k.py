#!/usr/bin/env python3
"""
YOLOv11 pose training for the 4-keypoint gauge dataset (yolo_dataset_1c4p_9k5p1).
...
DATASET_PATH = BASE_DIR / "yolo_dataset_1c4p_9k5p1"
DATASET_YAML = DATASET_PATH / "dataset_pose_1c4p_9k.yaml"
NUM_KEYPOINTS = 5
EXPECTED_LABEL_COLUMNS = 5 + NUM_KEYPOINTS * 3  # class + bbox + kpts
CLASS_NAMES = ['gauge']
RUN_PROJECT = Path('runs/pose')
RUN_NAME = 'yolov11_pointer_pose_1c5p_9k'
KEYPOINT_COLORS = [
    (0, 255, 0),
    (255, 0, 0),
    (0, 255, 255),
...
def main():
    """Entry point for launching training on the yolo_dataset_1c4p_9k5p1 dataset."""
    print("=" * 60)
    print("YOLOv11-Pose Training for Dial Gauge Pointer Detection")
    print("Training: BBox + 5 Keypoints")
